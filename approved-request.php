...
<div id="adminhome">
  ...
  <div>
    <p style="text-align: center;font-size: 50px;margin-bottom: 20px;color:white;">USERS APPROVED REQUEST</p>
  ...
  <table id="admintable" cellspacing="10">
    ...
    ?>
        ...
        <tr>
          ...
          <td>
            <a href="userblock.php?id=<?php echo $row['user_id']; ?>" name="block" class="block" style="color: pink;">BLOCK</a>
          </td>
