...
<div id="adminhome">
  ...
  <div>
    <p style="text-align: center;font-size: 50px;margin-bottom: 20px;color:white;">BLOCKED USERS</p>
  ...
  <table id="admintable" cellspacing="10">
    ...
    ?>
        ...
        <tr>
          ...
          <td>
            <a href="approved.php?id=<?php echo $row['user_id']; ?>" name="unblock" class="unblock" style="color: black">UNBLOCK</a>
          </td>
